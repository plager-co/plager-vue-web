...
var store = new _vuex.default.Store({
          ...
          var result = (0, _api.authenticate)(userData).then(function (response) {
            if (response.data.token) {
              ...
              if (response.data.user_type === 'influencer') {
                ...
                _router.default.push('/influencer-score');
              }
            } else {
  ...
  mutations: {
    ...
    setForceAlertPopup: function setForceAlertPopup(state, payload) {
  ...
  }), _defineProperty(_getters, "isForceAlertPopup", function isForceAlertPopup(state) {
