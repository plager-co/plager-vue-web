      ...
      <div class="section start gray">
          <div class="container">
              <div class="date">
                ...
                <a class="label">기간</a>
                <div class="date-box">
                    <input type="date" name="start" id="start" value='2018-08-01'>
                </div>
                <a class="label in">~</a>
                <div class="date-box">
                    <input type="date" name="end" id="start" value='2018-08-01'>
                </div>
            </div>
              ...
              <table class='for-mobile'>
                  <tbody>
                      <tr>
                          <td>노출</td>
                          <td class='bold'>총 8회</td>
                      </tr>
                      <tr>
                          <td>도달</td>
                          <td class='bold'>총 10회</td>
                      </tr>
                      <tr>
                          <td>좋아요</td>
                      ...
                      <tr>
                          <td>동영상</td>
                          <td class='bold'>300개/<br>3499재생</td>
                      </tr>
                      <tr>
                          <td>광고주계정 인바운드</td>
                          <td class='bold'>0회</td>
...
@media screen and (max-width: 640px) {
  ...
  .date-box input[type=date] { height: 2.2rem; padding: 0 0 0 .5rem; font-size: .9rem; letter-spacing: -.1rem; text-align: left;}
  ...
  h1 {font-size: 2rem; margin-bottom: .8rem; text-align: left;}
  ...
  .card .profile .state {margin-bottom: 1.3rem; font-size: 1.4rem; margin-bottom: .5rem;}
