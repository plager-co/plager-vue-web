    ...
    <div class="section fifth">
      <div class="container">
        ...
        <div class="part part1">
	      ...
	      <br>
	      <br>
              4) 일회성으로 끝나는 것이 아니라 광고주와 인플루언서의 선택에 따라 장기간 <br>
              SNS상에서 브랜드를 대표하는 얼굴로 활동하게 됩니다.
            </p>
	      ...
	      <br>
	      <br>
              4) 일회성으로 끝나는 것이 아니라 광고주와 인플루언서의 <br> 선택에 따라 장기간
              SNS상에서 브랜드를 대표하는<br> 얼굴로 활동하게 됩니다.
            </p>
          </div>
    ...
    return {
	 ...
	 profileList: [
      ...
      mainTextCarousel: [
        ...
        {
          subTitle: 'Go against the grain',
          title: ['“인플루언서의 일상과', ' 함께하는 브랜드”'],
          description: [
            ['데이터 통계와 알고리즘을 통해', ' 실제 영향력이 있는 인플루언서를 모델로' ],
            ['반복적인 노출을 통해 브랜드를 기억하게 됩니다.']
          ]
        },
        {
          ...
          title: ['“기억하지 못하면 잊혀진다”'],
          description: [
            ['고객이 기억하지 못하는 브랜드는', ' 영속성을 가질 수 없습니다.'],
	    ['무의식적으로 기억하고 있는 브랜드를', ' 고객은 우선적으로 경험하고 체험하기 원합니다.']            
          ]
        },
       /* {
