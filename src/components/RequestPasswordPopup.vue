<template>
    <form
         id="request-password-popup"
      @submit.prevent v-if='$store.state.isRequestPasswordPopup'
      novalidate="true"
    >
      >
    <div class="dim">
        <div class="join-popup">
            ...
            <div class="btn-wrap">
                ...
                <button class='prev' @click='$store.commit("closeRequestPasswordPopup")'>취소</button>
            </div>
        </div>
    </div>
     </form>
